export const PAGES = [
  ...
  },
  {
    id: 2,
    title: 'TODO 공동관리',
    content: `나의 펫을 위해 해야 하는 일, TODO를 Pamily들과 함께 공동으로 생성하고, 수정할 수 있어요!`,
    image: require('../../assets/Imgs/onboarding02.png'),
  },
  {
    id: 3,
    title: '달성률 확인',
    content: `나에게 할당된 TODO를 얼마나 이행했는지 메인 페이지를 통해 확인할 수 있어요! 나에게 할당된 TODO 중 얼마나 달성했는지 확인하세요!`,
    image: require('../../assets/Imgs/onboarding03.png'),
  },
  {
    id: 4,
    title: 'Pamily 권한',
    content: `포잇의 Pamily는 펫을 함께 키우는 모임, 단체를 의미해요! 포잇은 관리자, 운영진, 일반 멤버로 권한이 나누어지고, 관리자와 운영진에게는 Pamily 관리 권한이 주어져요!`,
...
export const routeList = ['인스타그램', '지인추천', '펫 커뮤니티', '검색', '기타']
