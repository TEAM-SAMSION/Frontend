  ...
  return (
    <ScreenLayout>
      <ScrollView showsVerticalScrollIndicator={false}>
        <Container>
          <Contents>
            앱개발 및 운영자는 앱 사용자의 개인정보를 중요시하며, 정보통신망 이용촉진 및 정보보호 등에 관한 법률,
            개인정보 보호법, 위치정보의 보호 및 이용등에 관한 법률 등 개인정보와 관련된 법령 상의 개인정보보호규정과
            행정안전부 및 방송통신위원회 등 유관기관이 제정한 가이드라인을 준수하고 있습니다. 또한 사용자의 개인정보를
            보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을
            공개합니다.
          </Contents>
          <Box>
            ...
            <Contents>
              ...
              이용과정에서 IP주소, 쿠키, 방문 일시 및 불량 이용 일시, 기기정보 등 서비스 이용 기록이 생성되어 수집될 수
              있습니다.{'\n'}
          ...
          <Box>
            ...
            <Contents>
              ...
              회원을 제외하고 나머지 제3자에게 제공하지 않습니다.{'\n'}- 사용자가 앱에서 제공하는 서비스를 이용하는
              동안은 사용자의 개인정보를 계속적으로 보유하지만 서비스 이용이 중지되면 개인정보는 즉시 삭제됩니다. 또한
              사용자가 직접 개인정보 삭제를 요청한 경우 즉시 삭제처리합니다.
            </Contents>
          </Box>
        </Container>
      </ScrollView>
