    ...
    <ScreenLayout>
      <Container>
        ...
        <Box>
          ...
          <Contents>
            포잇은 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다. 포잇 회원가입 시 수집하는 개인정보는 다음과
            같습니다. 서비스에 처음 가입하는 과정에서 서비스 내 개별 어플리케이션이나 프로그램 등을 통하여 ‘이메일’ 을
            수집하게 됩니다. 서비스 이용과정에서 이용자로부터 수집하는 개인정보는 다음과 같습니다. 서비스 이용과정에서
            IP주소, 쿠키, 방문 일시 및 불량 이용 일시, 기기정보 등 서비스 이용 기록이 생성되어 수집될 수 있습니다.
            구체적으로, 1 정보통신서비스 제공자는 서비스 이용 과정에서 이용자에 관한 정보를 자동화된 방식으로 생성하여
            저장하고, 2 이용자 기기의 고유정보를 안전한 형태로 변환하여 수집하는 것을 의미합니다. 포잇은 다음과 같은
            기업방법을 통해 개인정보를 수집합니다. 서비스 이용과정 및 서비스 이용과정에서 이용자가 개인정보 수집에
            동의하고 직접 해당 정보를 입력하는 경우 개인정보가 수집됩니다. 기기정보 등 생성정보는 모바일 앱 이용과정에서
