...
export default function TuMyPage3({ navigation }) {
    ...
    <ScreenLayout>
      ...
      >
        ...
        >
          ...
          >
            <GroupContainer>
              <Title style={{ color: colors.grey_100 }}>내가 속한 Pamily</Title>
              <Groups>
                <FlatList
                  data={groupInfo}
                  renderItem={({ item }) => {
          ...
          <View style={{ position: 'absolute', bottom: 180, width: ScreenWidth, alignItems: 'center' }}>
            <Body_Text color={colors.red_200}>내가 속한 Pamily의 목록을 확인할 수 있어요!</Body_Text>
            <Body_Text color={colors.red_200}>왕관 표시가 있는 모임은 내가 ‘관리자’인 모임이에요!</Body_Text>
          </View>
        </View>
