...
export default function TuAdmin3({ navigation }) {
      ...
      >
        ...
        >
          ...
          <View style={{ position: 'absolute', bottom: 180, width: ScreenWidth, alignItems: 'center' }}>
            <Body_Text color={colors.red_200}>운영하는 Pamily에 속한</Body_Text>
            <Body_Text color={colors.red_200}>펫과 회원의 수를 확인할 수 있어요</Body_Text>
          </View>
        </View>
        <TopNav>
          <TouchableOpacity
